...
/// Globally-reachable iOS app state so App Intents (which run outside the SwiftUI
/// view hierarchy) drive the same coordinator the UI uses. Mirrors macOS `SharedApp`.
@MainActor
enum SharedIOSApp {
